  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col h-[calc(100vh-120px)] space-y-3">
      <div className="flex justify-between items-center shrink-0">
        <div>
          <h1 className="text-xl font-bold text-gray-900">Dividend Log</h1>
          <p className="text-xs text-gray-500 mt-1">Manage and track your latest dividend income and bonus shares.</p>
        </div>
          <button
